...
public class A07CharacterTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("'가' 문자의 유니코드값 (10진수):" + (int)c3);	// 출력결과 - 가
		...
		int code3 = c3;
		char temp = (char)code3;			//**c3은 '가' 를 int 로 자동 캐스팅하면 44032
		System.out.println("code3 : " + code3);		//44033
		System.out.println("문자로 캐스팅한 code3 : " + temp);		//**int를 char로 강제 캐스팅. '각'
		
		code3++;				//code3+=1  을 줄인 수식.  1씩 더하는 코딩이 많아서 편의성을 위한 방법
		System.out.println("변경된 code3 : " + code3);		//44033
		System.out.println("변경된 code3 문자 : " + (char)code3);		//**int를 char로 강제 캐스팅. '각'. 출력형식을 바꾸기
